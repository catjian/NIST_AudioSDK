/***************************************************************************
* File name    :	SHA-256.c
* Function     :	SHA256 and SHA224 function
* Author       : 	howard
* Date         :	2010/09/03
* Version      :    v1.0
* Description  :     
...
/***************************************************************************
* Subroutine:	SHA256_Update
* Function:		SHA-256 process buffer
* Input:		ctx- the SHA256 struct
...
void SHA256_Update( SHA256_CONTEXT *ctx, UINT8 *input, INT32 ilen )
{
 ...
 /***************************************************************************
* Subroutine:	SHA256_Final
* Function:		SHA-256 final digest
* Input:		ctx- the SHA256 struct
* Output:		output- the result of hash;
* Description:	 
* Date:			2010.09.02
* ModifyRecord:
* *************************************************************************/ 
